...
export interface CustomizerColorInterface {
  code: string,
  class: string,
  active: boolean,
  type: string
}
export interface CustomizerTransparentColorInterface {
  class: string,
  active: boolean,
}
export interface CustomizerImageInterface {
  src: string,
  active: boolean,
}
...
export class CustomizerService {
  ...
  light_dark_colors: CustomizerColorInterface[] = [
    {
      code: "mint",
      class: "gradient-mint",
      active: false,
  ...
  transparent_colors: CustomizerTransparentColorInterface[] = [
    {
  ...
  light_dark_bg_images: CustomizerImageInterface[] = [
    {
  ...
  lightDarkLayoutGradientBGColors: CustomizerColorInterface[] = [];
  lightDarkLayoutSolidBGColors: CustomizerColorInterface[] = [];
  transparentLayoutBGColors: CustomizerTransparentColorInterface[] = [];
  transparentLayoutBGColorsWithShades: CustomizerTransparentColorInterface[] = [];
  lightDarkLayoutBGImages: CustomizerImageInterface[] = [];
  ...
  changeSidebarBGColor(color: CustomizerColorInterface) {
  ...
  changeSidebarTransparentBGColor(color: CustomizerTransparentColorInterface) {
    let conf = this.config.templateConf;
  ...
  changeSidebarBgImage(image: CustomizerImageInterface) {
    let conf = this.config.templateConf;
