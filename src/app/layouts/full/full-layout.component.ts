...
import {ConfigService, ITemplateConfig} from "app/shared/services/config.service";
...
export class FullLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  onWrapperClick() {
    this.isNavbarSearchTextEmpty = true;
  }

  checkNavbarSearchTextEmpty($event: Event) {
    this.isNavbarSearchTextEmpty = !!$event;
  }
